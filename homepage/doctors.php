...
<html class="no-js" lang="zxx">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<h3 class='doctor-name'> Dr " . htmlspecialchars($row['Doctor_Name']) . "</h3>";
            echo "<p class='doctor-degree'>" . htmlspecialchars($row['Doctor_Degree']) . "</p>";
            echo "</div>";
            ...
            echo "<p><strong>Email:</strong> " . htmlspecialchars($row['Doctor_mail']) . "</p>";
            echo "<p><strong>Experience:</strong> " . htmlspecialchars($row['yearsEXP']) . " years</p>";
            echo "<p><strong>Languages Known:</strong> " . htmlspecialchars($row['Languages_known']) . "</p>";
            echo "<p><strong>Location:</strong> " . htmlspecialchars($row['Location']) . "</p>";
            
            // Add Book Appointment button
            echo "<a href='Book-Appointment.html' class='book-appointment-btn'>Book Appointment</a>";
